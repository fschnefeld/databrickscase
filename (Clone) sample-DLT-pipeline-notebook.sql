...
AS SELECT * FROM cloud_files("intellishorefunctioning.default.supermarket_sales_sheet_1", "csv");
...
AS
SELECT * FROM cloud_files("intellishorefunctioning.default.supermarket_sales_sheet_1", "json", map("cloudFiles.inferColumnTypes", "true"))
